<footer class="container mx-auto h-[250px]">
  <nav class="h-full flex flex-col">
    <article class="flex mb-[35px]">
      ...
      <img src="image/Facebook.svg" alt="Facebook" class="mr-4">
      <img src="image/X.svg" alt="X" class="mr-4">
    ...
    <article>
      <p class="text-xs text-white">© 2024 GetFlix, Lucas Maroy/Amandine Van de Winckel/Alisabah Separ</p>
    </article>
  </nav>
</footer>
