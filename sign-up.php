...
<body class="bg-halfBlack sm:w-screen w-full h-fit">
    ...
    <main class="w-[80%] sm:container mx-auto h-[801px] sm:mb-14 mb-[39px] flex">
      <section class="login w-[651.81px] h-[775px] sm:h-full bg-greyWhite rounded-xl sm:mr-6 mr-0 flex flex-col items-center sm:mb-14 mb-[39px]">
        <article class="relative top-[50px]">
          ...
          <form action="#" method="post" class="flex flex-col mb-[10px]">
            <input type="username" name="username" placeholder="User Name" class="w-[234px] sm:w-[405px] h-[58px] border-2 border-pastelBlue rounded-xl text-center mb-4" value="<?php echo htmlspecialchars($username); ?>">
            ...
            <input type="password" name="confirm_password" placeholder="Confirm Password" class="w-[234px] sm:w-[405px] h-[58px] border-2 border-pastelBlue rounded-xl text-center mb-4"/>
            <span class="text-red-500"><?php echo htmlspecialchars($confirm_password_error); ?></span>      
            <input type="password" name="confirm-password" placeholder="Confirm Password" class="w-[234px] sm:w-[405px] h-[58px] border-2 border-pastelBlue rounded-xl text-center mb-4" value="<?php echo htmlspecialchars($fullname); ?>">
            <input type="fullname" name="fullname" placeholder="Full Name" class="w-[234px] sm:w-[405px] h-[58px] border-2 border-pastelBlue rounded-xl text-center mb-4" value="<?php echo htmlspecialchars($fullname); ?>" />
            <span class="text-red-500"><?php echo htmlspecialchars($fullname_error); ?></span>
            <input type="email" name="email" placeholder="Email" class="w-[234px] sm:w-[405px] h-[58px] border-2 border-pastelBlue rounded-xl text-center mb-4" value="<?php echo htmlspecialchars($email); ?>">
            ...
            <section class="bg-[#B1BBFC] h-[120px] w-[234px] sm:w-[405px] overflow-x-scroll flex items-center rounded-xl mb-4">
                    <article class="flex mx-4">                            
                        <?php foreach ($avatars as $image): ?>
                            <input type="radio" name="avatar" class="hidden last:mr-0 mr-4" value="<?php echo htmlspecialchars($image); ?>"<?php if (isset($avatar) && $avatar == $image) echo 'checked'; ?>>
                            <img src="<?php echo htmlspecialchars($avatar_directory . $image); ?>" alt="Avatar" class="last:mr-0 mr-4 flex-none h-[86px] w-[86px] rounded-full focus:outline-none focus:ring-2 focus:ring-greyWhite">
                        <?php endforeach;?>
                    </article>
