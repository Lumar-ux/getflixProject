                    ...
                    <article class="flex justify-between mx-4">                            
                        <?php foreach ($avatars as $image): ?>
                            <div class="flex-none w-20 h-20 mr-4">
                                <label>
                                    <input type="radio" name="avatar" value="<?php echo htmlspecialchars($image); ?>"<?php if (isset($avatar) && $avatar == $image) echo 'checked'; ?> class="hidden">
                                    <img src="<?php echo htmlspecialchars($avatar_directory . $image); ?>" alt="Avatar" tabindex="0" class="flex-none w-20 h-20 rounded-full cursor-pointer hover:ring-2 hover:ring-pastelBlue focus:ring-2 focus:ring-greyWhite">
                                </label>
                            </div>
                        <?php endforeach;?>
                    </article>
